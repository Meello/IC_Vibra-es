...
{
    public class PropriedadesGeométricas : IPropriedadesGeometricas
    {
        ...
        public double MomentoInercia(double diametro, double espessura)
        {
            double d = diametro;
            double t = espessura;
        ...
        public double MomentoInercia(double altura, double largura, double espessura)
        {
            double a = altura;
            double b = largura;
            double t = espessura;
