...
namespace IC_Vibracao.MatrizBase
{
    public class MatrizBase
    {
        ...
        public double[,] Matriz(Barra barra)
        {
			...
			double densidade = barra.Material.Densidade;
		...
		public double[,] Rigidez(Barra barra)
		{
			...
			double[] moEl = this._matrizes.ModuloElasticade(barra.Material.ModuloElasticidade);
			double l = barra.Comprimento;
			int p, q, r, s;
